#!/bin/bash
# Run LSS GLM for all 20 subjects in parallel (2 groups)
...
echo "========================================"
echo "LSS GLM Parallel Execution"
echo "========================================"
...
# Batch 1: subjects 1-10
# Batch 2: subjects 11-20
run_lss_batch 1 10 "batch1" &
PID1=$!

run_lss_batch 11 20 "batch2" &
PID2=$!

echo "Batch 1 (subjects 1-10) started with PID: $PID1"
echo "Batch 2 (subjects 11-20) started with PID: $PID2"
echo ""
echo "Monitoring progress..."
echo "You can tail the logs with:"
echo "  tail -f $LOG_DIR/lss_glm_batch1_${TIMESTAMP}.log"
echo "  tail -f $LOG_DIR/lss_glm_batch2_${TIMESTAMP}.log"
echo ""
...
echo "========================================"
echo "Batch 1 (subjects 1-10): Exit code $EXIT1"
